...
class UserController extends BaseController {
  ...
  Future<void> sendOtpWithGoogleSignIn({required Map<String, dynamic> params}) async {
    ...
    try {
      ...
      await apiService.postRequest(
          url: "${ApiUrl.baseUrl}${ApiUrl.sendOtpWithAuth}",
          params: params,
          onSuccess: (Map<String, dynamic> data) {
            dismissLoader();
            params["otp"] = data["response"]["otp"];
  ...
  Future<void> verifyOTpWithAuth(String otp) async {
    ...
    try {
      ...
      await apiService.postRequest(
          url: "${ApiUrl.baseUrl}${ApiUrl.verifyOtpWithAuth}",
          params: params,
          onSuccess: (Map<String, dynamic> data) {
            dismissLoader();
  ...
  Future<void> getPromoCodeList() async {
    try {
      showLoader();
      await apiService.getRequest(
          url: "${ApiUrl.baseUrl}${ApiUrl.promoCodesList}",
          onSuccess: (Map<String, dynamic> data) {
            dismissLoader();
            promoCodeList.clear();
  ...
  Future<void> getWalletTransaction() async {
    try {
      showLoader();
      await apiService.getRequest(
          url: "${ApiUrl.baseUrl}${ApiUrl.passBook}",
          onSuccess: (Map<String, dynamic> data) {
            dismissLoader();
  ...
  Future<void> getLocation() async {
    try {
      // showLoader();
      await apiService.getRequest(
          url: "${ApiUrl.baseUrl}${ApiUrl.location}",
          onSuccess: (Map<String, dynamic> data) async {
            dismissLoader();
  ...
  Future<void> deleteLocation({required String id}) async {
    try {
      ...
      await apiService.deleteRequest(
          url: "${ApiUrl.baseUrl}${ApiUrl.location}" + "/$id",
          onSuccess: (Map<String, dynamic> data) async {
            dismissLoader();
            showSnack(msg: "${data["response"]["message"]}");
          },
  ...
  Future<void> updateProfile(int isFrom) async {
    try {
      ...
      await apiService.postRequest(
          url: "${ApiUrl.baseUrl}${ApiUrl.updateProfile}",
          params: formData,
          onSuccess: (Map<String, dynamic> data) async {
            dismissLoader();
  ...
  Future<void> createCard({Map<String, dynamic> cardParams = const {}}) async {
    try {
      ...
      dio.FormData formData = new dio.FormData.fromMap(params);
      await apiService.postRequest(
          url: "${ApiUrl.baseUrl}${ApiUrl.createCard}",
          params: formData,
          onSuccess: (Map<String, dynamic> data) async {
            dismissLoader();
            Get.back();
  ...
  Future<void> getCardList() async {
    try {
      ...
      await apiService.getRequest(
          url: "${ApiUrl.baseUrl}${ApiUrl.cardList}/${userData.value.stripeCustId ?? ""}",
          onSuccess: (Map<String, dynamic> data) async {
            dismissLoader();
            cardList.clear();
  ...
  Future<void> walletAddMoney({required String money}) async {
    try {
      ...
      params["customer_id"] = userData.value.stripeCustId ?? "";
      await apiService.postRequest(
          url: "${ApiUrl.baseUrl}${ApiUrl.walletAdd}",
          params: params,
          onSuccess: (Map<String, dynamic> data) async {
            dismissLoader();
            _walletAddModel =
